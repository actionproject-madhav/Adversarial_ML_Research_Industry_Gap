"""
USENIX Adversarial ML Paper Analysis - OpenAI Version
Reads PDFs from USENIX folder structure (2022-2025) and analyzes using GPT-4
...
def scan_pdf_folder(base_path: str) -> List[Dict]:
    ...
    Args:
        base_path: Path to usenix_papers_2022_2025 folder (or current directory)
...
def analyze_all_papers(base_path: str, output_csv: str, delay: float = 1.0, resume: bool = True):
    ...
    print("="*80)
    print("USENIX ADVERSARIAL ML PAPER ANALYSIS (2022-2025)")
    print("="*80)
...
def print_statistics(df: pd.DataFrame):
    ...
    print("\n" + "="*80)
    print("USENIX PAPERS SUMMARY STATISTICS (2022-2025)")
    print("="*80)
...
if __name__ == "__main__":
    ...
    2. Run from the usenix_papers_2022_2025/ directory:
       python benchmark_review_automation.py
       
    OR from parent directory:
       cd usenix_papers_2022_2025 && python benchmark_review_automation.py
    ...
    # Configuration
    # BASE_PATH should be the script's directory (usenix_papers_2022_2025)
    script_dir = Path(__file__).parent.resolve()
    BASE_PATH = str(script_dir)  # Use script's directory as base path
    OUTPUT_CSV = str(script_dir / "usenix_analysis_results_2022_2025.csv")
    ...
    if not year_folders:
        ...
        print(f"\nPlease run from the usenix_papers_2022_2025/ directory")
        print("Expected structure:")
        print("  usenix_papers_2022_2025/")
        print("    ├── 2022/")
        print("    ├── 2023/")
        print("    ├── 2024/")
        print("    ├── 2025/")
